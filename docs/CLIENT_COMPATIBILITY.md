...
and `features/hooks.md` (`PreToolUse`/`Stop`/etc., `hookSpecificOutput.
permissionDecision`, `.qwen/settings.json` config surface — added
2026-08-29). A real agentic-session live-verification (the standard
